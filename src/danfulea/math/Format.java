...
/**
 * A class for formatting numbers that follows printf conventions. Based on code
 * (free tutorial available on web) written by Cay Horstmann, version 1.04 13
 * Sep 1998
 * 
...
public class Format {
	...
	public static String getStringFormatted(String fmt, double x) {
	...
	public static void main(String[] a) {
		double x = 0.00000000000000000123456789;// 1.23456789012;
		double y = 123;
		double z = 1.2345e30;
		double w = 1.02;
		double u = 1.234e-5;
		...
		System.out.println("-------------------------------------");
		Format.print(System.out, "x = |%0.2e|\n", x);
		String strNumber = Format.getStringFormatted("%0.2e", x);
		System.out.println("variabila string strNumber= " + strNumber);
		System.out.println("-------------------------------------");
	...
	/**
	 * Repeat a char c in a string, n times.
	 * @param c c
	 * @param n n
	 * @return the string
	 */
	...
	//example for 8 base: r = convert(x, 3, 7, "01234567");
	/**
	 * Internal method for converting. Example for 8 base: r = convert(x, 3, 7, "01234567");
	 * @param x x
	 * @param n n
	 * @param m m
	 * @param d d
	...
	/**
	 * Used to fit string into a fixed available space.
	 * @param r the String
	 ...
	 * @param s the sign
	 * @param r the String
	 * @return the "signed" formatted String
	 */

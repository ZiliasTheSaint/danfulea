...
/**
 * Class for visualize a 3D SpurGear. It is based on old java3D tutorials freely available on the web (at that time).
 * 
...
public class SpurGear extends Gear {
	 ...
	 *            subtended by the valley (must be less or equal than .25)
	 */
	 ...
	 * @param toothToValleyAngleRatio
	 *            the ratio of the angle subtended by the tooth to the angle
	 *            subtended by the valley (must be less or equal to .25)
	 * @param look

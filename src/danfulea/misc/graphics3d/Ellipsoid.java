...
/**
 * Class for visualize a 3D Ellipsoid. It is based on old java3D tutorials freely available on the web (at that time).
 * 
...
public class Ellipsoid extends Shape3D {
	...
	public Ellipsoid(int strips, int stripLength, Color4f c1, Color4f c2,
	...
	private double radiusz(int strip, int segment) {
		...
		return radius;
		// --------------------------------------------------------------
		// return 0.4*(strip + 1 - segment)/(double)strips;//c=0.4!!!
		// This version makes the inside of the bowl opaque
		// return (strip + segment)/(double)strips;
	}

...
public class SortButtonRenderer extends JButton implements TableCellRenderer {
	...
	/**
	 * Retrieve the table cell rendered component, i.e. the sortable button.
	 * @param table dummy entry
	 * @param value the value to be set on the button
	 * @param isSelected dummy entry
	 * @param hasFocus dummy entry
	 * @param row dummy entry

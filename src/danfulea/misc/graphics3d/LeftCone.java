...
/**
 * Class for visualize a 3D LeftCone. It is based on old java3D tutorials freely available on the web (at that time).
 * 
 * @author Dan Fulea, 12 MAY. 2005
 *
 */

public class LeftCone extends Shape3D {
	...
	public LeftCone(int strips, int stripLength, Color4f c1, Color4f c2,

...
/**
 * Class for visualize a 3D Gear. It is based on old java3D tutorials freely available on the web (at that time).
 * 
...
public class Gear extends javax.media.j3d.TransformGroup {
	...
	void addBodyDisks(float shaftRadius, float bodyOuterRadius,
		...
		double toothValleyStartAngle, nextToothStartAngle;
